...
//@Repository
//@Primary
//class StudentRepositoryImp(@Autowired var template:ReactiveMongoTemplate):
...
//        return template.
////            .findAll("students")
////            .findAll(Document::class.java)
////            .doOnNext { it.set("group_id", template.findById(it.get("group_id"), Group::class.java)) }
////            .map {template.converter.read(Student::class.java,it) }
//    }
//
